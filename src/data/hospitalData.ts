...
export const doctors: Doctor[] = [
  {
    ...
    exp: "20+ Years",
    rghsCard: "RGHS Not Applicable",
    extension: "101",
    codeNumber: "88173",
    schedule: [{ day: "Tue, Thu & Sat", time: "11:30 AM – 01:00 PM" }],
    fees: "₹600",
    phone: "9829055512",
    bio: "Dr. Shailendra Sharma is the Managing Director and Senior Consultant Orthopaedic at Jaipur Hospital with extensive expertise in joint replacement, complex trauma, and bone reconstructive surgery.",
    education: educationFromQual("MBBS, MS (Orthopedics)"),
    specializations: ["Orthopaedic Surgery", "Joint Replacement", "Complex Trauma Management", "Bone Reconstruction"],
  ...
  },
  {
    ...
    extension: "112",
    codeNumber: "88223",
    schedule: [{ day: "Mon – Sat", time: "11:00 AM – 04:00 PM" }],
    fees: "₹500",
    phone: "9829183130",
    bio: "Dr. Rajiv Sharma is an experienced orthopaedic surgeon at Jaipur Hospital specializing in orthopaedic consultations, fracture management, and musculoskeletal care.",
    education: educationFromQual("MBBS, MS (Orthopedics)"),
    specializations: ["Orthopaedic Surgery", "Fracture Management", "Joint Care"],
    languages: ["Hindi", "English"],
  },
  {
    ...
    extension: "112",
    codeNumber: "88224",
    schedule: [{ day: "Tue – Sat", time: "10:00 AM – 02:00 PM" }],
    fees: "₹500",
    phone: "9414116108",
    bio: "Dr. Pramod Kumar Jain is a senior orthopaedic surgeon at Jaipur Hospital with deep expertise in bone, joint, and trauma surgery.",
    education: educationFromQual("MBBS, MS (Orthopedics)"),
    specializations: ["Orthopaedic Surgery", "Joint Care", "Trauma & Fracture Care"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-r-l-modi",
    ...
    extension: "103",
    codeNumber: "88593",
    schedule: [{ day: "Mon – Sat", time: "10:00 AM – 01:00 PM" }],
    fees: "₹400",
    phone: "9414373803",
    bio: "Dr. R. L. Modi is a senior physician at Jaipur Hospital specializing in general medicine, infectious illnesses, and chronic health management.",
    education: educationFromQual("MBBS, MD (General Medicine)"),
    specializations: ["General Medicine", "Internal Medicine", "Chronic Disease Management"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-ashish-gupta",
    ...
    exp: "Experienced",
    codeNumber: "88105",
    schedule: [{ day: "Mon – Sat", time: "09:30 AM – 02:00 PM" }],
    fees: "₹500",
    bio: "Dr. Ashish Gupta is a consultant physician at Jaipur Hospital providing comprehensive medical care for fever, lifestyle diseases, and internal medicine.",
    education: educationFromQual("MBBS, MD (General Medicine)"),
    specializations: ["General Medicine", "Infectious Diseases", "Lifestyle Disorders"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-mayank-gupta",
    ...
    qual: "MBBS, MD (General Medicine), Diabetologist",
    dept: "General Medicine",
    designation: "Consultant Physician & Diabetologist",
    exp: "Experienced",
    extension: "113",
    codeNumber: "88222",
    schedule: [{ day: "Mon – Sat", time: "11:00 AM – 03:30 PM" }],
    fees: "₹500",
    phone: "9887528604",
    bio: "Dr. Mayank Gupta is a physician and diabetologist at Jaipur Hospital with specialized practice in diabetes care, metabolic disorders, and internal medicine.",
    education: educationFromQual("MBBS, MD (General Medicine)"),
    specializations: ["General Medicine", "Diabetology", "Metabolic Disorders", "Hypertension"],
    languages: ["Hindi", "English"],
  },
  {
    ...
    extension: "111",
    codeNumber: "88681",
    schedule: [{ day: "Mon – Sat", time: "09:30 AM – 02:30 PM" }],
    fees: "₹500",
    phone: "9829128437",
    bio: "Dr. Sandeep Sharma specializes in Internal Medicine with MBBS and MD, focusing on adult diseases, diabetes, and preventive health.",
    education: educationFromQual("MBBS, MD (Internal Medicine)"),
    specializations: ["Internal Medicine", "Preventive Healthcare", "Chronic Illness"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-jaideep-mathur",
    img: getDoctorImg("No Image"),
    name: "Dr. Jaideep Mathur",
    qual: "MBBS, MS (General Surgery)",
    dept: "General Surgery",
    designation: "Consultant General Surgeon (On Call)",
    exp: "Experienced",
    extension: "108",
    schedule: [{ day: "Tue, Thu & Sat", time: "09:30 AM – 10:30 AM" }],
    fees: "₹500",
    phone: "9950995625",
    bio: "Dr. Jaideep Mathur is a skilled general surgeon on call at Jaipur Hospital, offering surgical consultations and operations.",
    education: educationFromQual("MBBS, MS (General Surgery)"),
    specializations: ["General Surgery", "Laparoscopic Procedures", "Surgical Consultations"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-arun-mathur",
    ...
    extension: "103",
    codeNumber: "88103",
    schedule: [{ day: "Mon – Sat", time: "11:30 AM – 12:30 PM" }],
    fees: "₹500",
    phone: "9829056916",
    bio: "Dr. Arun Mathur is a renowned plastic and reconstructive surgeon with MBBS, MS, and MCh, specializing in aesthetic and corrective surgery.",
    education: educationFromQual("MBBS, MS, MCh (Plastic Surgery)"),
    specializations: ["Plastic Surgery", "Reconstructive Surgery", "Cosmetic Procedures", "Burn Reconstruction"],
    languages: ["Hindi", "English"],
  },
  {
    ...
    extension: "106",
    codeNumber: "88163",
    schedule: [{ day: "Mon, Wed, Thu & Sat", time: "10:00 AM – 12:00 PM" }],
    otDays: "Tuesday, Friday",
    fees: "₹500",
    phone: "9829194477",
    bio: "Dr. Suhasini Shitoot is a senior gynaecologist and obstetrician at Jaipur Hospital specializing in normal and high-risk deliveries, laparoscopic surgeries, and women's wellness.",
    education: educationFromQual("MBBS, DGO, MD (Obstetric & Gynaecology)"),
    specializations: ["Obstetrics", "Gynaecology", "Maternity Care", "High-Risk Pregnancy", "Laparoscopic Gynae Surgeries"],
    languages: ["Hindi", "English"],
  },
  {
    ...
    extension: "108",
    codeNumber: "88111",
    schedule: [{ day: "Mon – Sat", time: "12:00 PM – 01:00 PM" }],
    fees: "₹500",
    phone: "9829083221",
    bio: "Dr. Dinesh Kumar Dalmia is an experienced paediatrician at Jaipur Hospital providing expert medical care for infants, children, and adolescents.",
    education: educationFromQual("MBBS, MD (Paediatric)"),
    specializations: ["Paediatrics", "Neonatal Care", "Child Vaccinations", "Childhood Illnesses"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-pavan-kumar-shorey",
    img: getDoctorImg("p-600x700.jpg"),
    name: "Dr. Pawan Kumar Shorey",
    ...
    fees: "₹600",
    phone: "9414045217",
    bio: "Dr. Pawan Kumar Shorey is an ophthalmologist with MBBS and MS (Ophthalmology), specializing in cataract surgery, refractive errors, and comprehensive eye care.",
    education: educationFromQual("MBBS, MS (Ophthalmology)"),
    specializations: ["Ophthalmology", "Cataract Surgery", "Eye Care", "Glaucoma Screening"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-anita-kothari",
    ...
    extension: "102",
    codeNumber: "88665",
    schedule: [{ day: "Mon – Sat", time: "11:30 AM – 01:30 PM" }],
    fees: "₹500",
    phone: "9314933668",
    bio: "Dr. Anita Kothari is an experienced ENT specialist with MBBS and MS (ENT), treating diseases of the ear, nose, throat, and sinus.",
    education: educationFromQual("MBBS, MS (ENT)"),
    specializations: ["ENT", "Ear, Nose & Throat Surgeries", "Sinusitis", "Hearing Care"],
    languages: ["Hindi", "English"],
  },
  {
    ...
    dept: "Cardiology",
    designation: "Cardiac & CTVS Surgeon",
    exp: "Experienced",
    extension: "110",
    codeNumber: "88254",
    schedule: [{ day: "Mon – Sat", time: "10:00 AM – 06:00 PM" }],
    fees: "₹400",
    phone: "9829175031",
    bio: "Dr. Ram Singh Yadav is a senior cardiac thoracic and vascular surgeon (CTVS) with MBBS and MCh, dedicated to comprehensive surgical heart care.",
    education: educationFromQual("MBBS, MCh (Cardiac Thoracic Surgery)"),
    specializations: ["Cardiac Thoracic Surgery", "CTVS", "Bypass Surgery", "Vascular Surgery"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-bhavesh-meel",
    ...
    exp: "Experienced",
    extension: "116, 511, 508",
    codeNumber: "88585",
    schedule: [{ day: "Mon – Sat", time: "11:30 AM – 06:00 PM" }],
    fees: "₹500",
    phone: "8003692691",
    bio: "Dr. Bhavesh Meel is an interventional cardiologist with MBBS, MD, and DNB (Cardiology), offering comprehensive cardiac diagnostics and therapy.",
    education: educationFromQual("MBBS, MD, DNB (Cardiology)"),
    specializations: ["Cardiology", "Interventional Cardiology", "Angiography & Angioplasty", "Heart Failure Management"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-adheer-yadav",
    img: getDoctorImg("No Image"),
    name: "Dr. Adheer Yadav",
    ...
    schedule: [{ day: "Mon – Sat", time: "10:00 AM – 06:00 PM" }],
    fees: "₹500",
    bio: "Dr. Adheer Yadav is a consultant cardiologist at Jaipur Hospital providing OPD consultations and inpatient cardiac care.",
    education: educationFromQual("MBBS, MD (Cardiology)"),
    specializations: ["Cardiology", "Clinical Cardiology", "Heart Disease Management"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-vikram-yadav",
    img: getDoctorImg("Dr. Vikram Singh Yadav.webp"),
    name: "Dr. Vikram Singh Yadav",
    qual: "BPT, MPT (Physiotherapy & Rehabilitation)",
    dept: "Physiotherapy",
    designation: "Senior Consultant Physiotherapist",
    exp: "15+ Years",
    rghsCard: "RGHS Not Applicable",
    codeNumber: "88242",
    schedule: [{ day: "Mon – Sat", time: "10:00 AM – 02:00 PM" }],
    fees: "₹350",
    otDays: "RGHS Not",
    phone: "9414218472",
    bio: "Dr. Vikram Singh Yadav is a senior physiotherapist at Jaipur Hospital specializing in orthopaedic, sports injury, and neurological rehabilitation with comprehensive pain management.",
    education: educationFromQual("BPT, MPT (Physiotherapy & Rehabilitation)"),
    specializations: ["Physiotherapy", "Post-Surgical Rehab", "Sports Injuries", "Spine Rehabilitation", "Joint Mobilization", "Pain Management"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-shabista-tarafta",
    img: getDoctorImg("Dr. Shabista Tarafta.webp"),
    name: "Dr. Shabista Tarafta",
    qual: "BPT, MPT (Physiotherapy & Rehabilitation)",
    dept: "Physiotherapy",
    ...
    fees: "₹350",
    phone: "0141-2741465",
    bio: "Dr. Shabista Tarafta is a dedicated consultant physiotherapist at Jaipur Hospital specializing in neurological rehabilitation, musculoskeletal therapy, post-operative recovery, and female health rehabilitation.",
    education: educationFromQual("BPT, MPT (Physiotherapy & Rehabilitation)"),
    specializations: ["Physiotherapy", "Musculoskeletal Rehabilitation", "Neuro Rehabilitation", "Post-Operative Recovery", "Pain Management", "Mobility Rehab"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-jahanvi-tyagi",
    img: getDoctorImg("No Image"),
    name: "Dr. Jahanvi Tyagi",
    qual: "BDS, MDS (Dentistry)",
    dept: "Dentistry",
    exp: "Experienced",
    rghsCard: "RGHS Not Applicable",
    schedule: [{ day: "Mon – Sat", time: "10:00 AM – 03:00 PM" }],
    fees: "₹300",
    phone: "8209011472",
    bio: "Dr. Jahanvi Tyagi is a dental surgeon at Jaipur Hospital providing advanced dental treatments, oral healthcare, and restorative procedures.",
    education: educationFromQual("BDS, MDS (Dentistry)"),
    specializations: ["Dental Surgery", "Root Canal Treatment", "Cosmetic Dentistry", "Oral Care"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-rachna-meena",
    img: getDoctorImg("No Image"),
    name: "Dr. Rachna Meena",
    qual: "MBBS, MD (Sonology & Radiology)",
    dept: "Diagnostics",
    designation: "Consultant Sonologist & Radiologist",
    exp: "Experienced",
    schedule: [{ day: "Mon – Sat", time: "12:00 PM – 04:00 PM" }],
    bio: "Dr. Rachna Meena is a consultant sonologist at Jaipur Hospital specializing in diagnostic ultrasound, obstetrics sonography, and colour Doppler imaging.",
    education: educationFromQual("MBBS, MD (Radiology)"),
    specializations: ["Sonography", "Ultrasound", "Colour Doppler", "Diagnostic Radiology"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dt-shiya",
    img: getDoctorImg("No Image"),
    name: "Dt. Shiya",
    qual: "M.Sc (Clinical Nutrition & Dietetics)",
    dept: "Dietetics",
    designation: "Clinical Dietitian",
    exp: "Experienced",
    schedule: [{ day: "Mon – Sat", time: "10:00 AM – 05:00 PM" }],
    phone: "8683086906",
    bio: "Dt. Shiya is a clinical dietitian at Jaipur Hospital designing customized medical nutrition and diet management plans for inpatient and outpatient recovery.",
    education: educationFromQual("M.Sc (Clinical Nutrition & Dietetics)"),
    specializations: ["Clinical Nutrition", "Diet Planning", "Diabetes & Cardiac Diet", "Weight Management"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-anu-agarwal",
    ...
    exp: "Experienced",
    codeNumber: "88101",
    schedule: [{ day: "Mon – Sat", time: "On Call / OT Schedule" }],
    bio: "Dr. Anu Agarwal is a senior consultant anaesthetist with MBBS and MD (Anaesthesia) at Jaipur Hospital.",
    education: educationFromQual("MBBS, MD (Anaesthesia)"),
    specializations: ["Anaesthesia", "Critical Care", "Pain Management"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-deepak-kumar",
    ...
    exp: "Experienced",
    schedule: [{ day: "Mon – Sat", time: "Cardiac OT / On Call" }],
    ...
    education: educationFromQual("MBBS, MD (Anaesthesia)"),
    specializations: ["Cardiac Anaesthesia", "Critical Care", "Cardiac ICU"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-ramesh-gupta",
    ...
    qual: "MBBS, MD (Anaesthesia)",
    dept: "Anaesthesia",
    designation: "Consultant Anaesthetist (On Call)",
    exp: "Experienced",
    schedule: [{ day: "Mon – Sat", time: "On Call" }],
    bio: "Dr. Ramesh Gupta is an anaesthetist with MBBS and MD (Anaesthesia), available on call for emergency and elective surgeries.",
    education: educationFromQual("MBBS, MD (Anaesthesia)"),
    specializations: ["Anaesthesia", "Surgical Sedation", "Critical Care"],
    languages: ["Hindi", "English"],
  },
  {
    id: "dr-sourabh-gupta",
    ...
    exp: "Experienced",
    schedule: [{ day: "Mon – Sat", time: "On Call" }],
    bio: "Dr. Sourabh Gupta is a consultant anaesthetist on call providing surgical anaesthesia and acute pain care.",
    education: educationFromQual("MBBS, MD (Anaesthesia)"),
    specializations: ["Anaesthesia", "Critical Care", "Pain Management"],
    languages: ["Hindi", "English"],
  },
  {
    ...
    schedule: [{ day: "Mon – Sat", time: "09:00 AM – 08:00 PM" }],
    languages: ["Hindi", "English"],
  },
  {
...
<p>Do not let joint pain limit your life. Reach out to our bone specialist in Jaipur today and take the first step toward a more active, pain-free life.</p>`,
  },
  {
    ...
    doctorIds: ["dr-deepak-kumar", "dr-bhavesh-meel", "dr-ram-singh-yadav", "dr-adheer-yadav"],
    img: heartImg,
...
<p>Do not take chances with heart care. Come to Jaipur Hospital, one of the most trusted names for heart treatment in Jaipur, and get a proper hold on your cardiac health today.</p>`,
  },
  {
    ...
    doctorIds: ["dr-jaideep-mathur", "dr-srikant-bulakh", "dr-mansimrat-paul-singh"],
    img: emergencyImg,
...
<p>If surgery has been recommended or you want a second opinion, speak to our team at Jaipur Hospital. As a trusted laparoscopy hospital in Jaipur, we will give you an honest assessment and the skilled care you deserve.</p>`,
  },
  {
    ...
    doctorIds: ["dr-r-l-modi", "dr-ashish-gupta", "dr-mayank-gupta", "dr-sandeep-sharma", "dr-pushpendra-prasad-garg"],
    img: heartImg,
...
<p>In a medical emergency, time is of the essence. Rely on Jaipur Hospital, the dependable emergency ICU in Jaipur, for assistance when you most need it.</p>`,
  },
  {
    ...
    doctorIds: ["dr-rachna-meena", "dr-divya-meel"],
    img: icuImg,
...
<p>Accurate diagnosis is the first step toward effective treatment. Visit our diagnostic centre in Jaipur and get reliable results that you and your doctor can act on.</p>`,
  },
  {
    ...
    doctorIds: ["dr-vikram-yadav", "dr-shabista-tarafta"],
    img: icuImg,
